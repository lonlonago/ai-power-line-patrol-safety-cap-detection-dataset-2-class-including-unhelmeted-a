# AI Power Line Patrol Safety Cap Detection Dataset】2-class including unhelmeted and helmeted.

# Body

AI Power Line Safety Cap Detection Dataset】2-class classification includes not wearing a safety cap and wearing a safety cap. Totally 295 images in the dataset. The script for splitting the dataset is provided. No data augmentation has been applied, including xml and txt files. Introduction to the dataset: Currently, most safety cap detections are targeted at construction sites and large machinery. There are few datasets available for power industry safety cap detection. Here we have selected a safety cap detection dataset, most of which come from the power industry, including scenarios such as pole installation, high-voltage tower construction, and power line repair; a small part comes from other industries. Interested parties can contact us for more information.
